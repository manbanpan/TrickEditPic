...
NSString *const kTceEditFerLvJySutroShaderString = SHADER_STRING
(
...
@implementation TceEditFerLvJyFilter14

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kTceEditFerLvJySutroShaderString]))
    {
        return nil;
    }
...
@implementation TceEditFerLvJySutroFilter
...
- (id)init
{
    ...
    TceEditFerLvJyFilter14 *filter = [[TceEditFerLvJyFilter14 alloc] init];
