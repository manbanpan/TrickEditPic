...
NSString *const kTceEditFerLvJyAmaroShaderString = SHADER_STRING
(
...
@implementation TceEditFerLvJyFilter3

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kTceEditFerLvJyAmaroShaderString]))
    {
        return nil;
    }
...
@implementation TceEditFerLvJyAmaroFilter
...
- (id)init
{
    ...
    TceEditFerLvJyFilter3 *filter = [[TceEditFerLvJyFilter3 alloc] init];
