//
//  TceEditFerLvJyValenciaFilter.m
...
NSString *const kTceEditFerLvJyValenciaShaderString = SHADER_STRING
(
...
@implementation TceEditFerLvJyFilter8

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kTceEditFerLvJyValenciaShaderString]))
    {
        return nil;
    }
...
@implementation TceEditFerLvJyValenciaFilter
...
- (id)init
{
    ...
    TceEditFerLvJyFilter8 *filter = [[TceEditFerLvJyFilter8 alloc] init];
