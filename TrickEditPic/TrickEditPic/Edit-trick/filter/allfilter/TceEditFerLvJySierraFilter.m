...
NSString *const kTceEditFerLvJySierraShaderString = SHADER_STRING
(
...
@implementation TceEditFerLvJyFilter11

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kTceEditFerLvJySierraShaderString]))
    {
        return nil;
    }
...
@implementation TceEditFerLvJySierraFilter
...
- (id)init
{
    ...
    TceEditFerLvJyFilter11 *filter = [[TceEditFerLvJyFilter11 alloc] init];
