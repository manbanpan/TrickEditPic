...
NSString *const kTceEditFerLvJyHudsonShaderString = SHADER_STRING
(
...
@implementation TceEditFerLvJyFilter5

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kTceEditFerLvJyHudsonShaderString]))
    {
        return nil;
    }
...
@implementation TceEditFerLvJyHudsonFilter
...
- (id)init
{
    ...
    TceEditFerLvJyFilter5 *filter = [[TceEditFerLvJyFilter5 alloc] init];
    ...
    UIImage *image2 = [UIImage imageNamed:@"hudsonMap"];
