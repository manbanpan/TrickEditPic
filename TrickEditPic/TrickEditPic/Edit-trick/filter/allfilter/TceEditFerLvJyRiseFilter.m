...
NSString *const kTceEditFerLvJyRiseShaderString = SHADER_STRING
(
...
@implementation TceEditFerLvJyFilter4

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kTceEditFerLvJyRiseShaderString]))
    {
        return nil;
    }
...
@implementation TceEditFerLvJyRiseFilter
...
- (id)init
{
    ...
    TceEditFerLvJyFilter4 *filter = [[TceEditFerLvJyFilter4 alloc] init];
