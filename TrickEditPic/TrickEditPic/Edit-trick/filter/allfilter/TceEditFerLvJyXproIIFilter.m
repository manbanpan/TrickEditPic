...
@implementation TceEditFerLvJyFilter12
...
@implementation TceEditFerLvJyXproIIFilter
...
- (id)init
{
    ...
    TceEditFerLvJyFilter12 *filter = [[TceEditFerLvJyFilter12 alloc] init];
