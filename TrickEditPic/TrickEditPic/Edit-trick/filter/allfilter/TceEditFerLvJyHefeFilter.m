...
NSString *const kTceEditFerLvJyHefeShaderString = SHADER_STRING
(
...
@implementation TceEditFerLvJyFilter17

- (id)init
{
    if (!(self = [super initWithFragmentShaderFromString:kTceEditFerLvJyHefeShaderString]))
    {
        return nil;
    }
...
@implementation TceEditFerLvJyHefeFilter
...
- (id)init
{
    ...
    TceEditFerLvJyFilter17 *filter = [[TceEditFerLvJyFilter17 alloc] init];
