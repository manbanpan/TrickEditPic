//
//  TceEditFerLvJyEarlybirdFilter.m
...
@implementation TceEditFerLvJyFilter13
...
@implementation TceEditFerLvJyEarlybirdFilter
...
- (id)init
{
    ...
    TceEditFerLvJyFilter13 *filter = [[TceEditFerLvJyFilter13 alloc] init];
