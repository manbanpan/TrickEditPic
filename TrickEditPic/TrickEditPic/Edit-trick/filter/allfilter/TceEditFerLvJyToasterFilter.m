...
NSString *const kTceEditFerLvJyToasterShaderString = SHADER_STRING
(
...
@implementation TceEditFerLvJyFilter15

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kTceEditFerLvJyToasterShaderString]))
    {
        return nil;
    }
...
@implementation TceEditFerLvJyToasterFilter
...
- (id)init
{
    ...
    TceEditFerLvJyFilter15 *filter = [[TceEditFerLvJyFilter15 alloc] init];
